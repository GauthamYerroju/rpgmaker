...
{
	document.getElementById("quickReplyExpand1").src = smf_images_url + "/" + (quickReplyCollapsed ? "cat-collapseL.gif" : "cat-expandL.gif");
	document.getElementById("quickReplyExpand2").src = smf_images_url + "/" + (quickReplyCollapsed ? "cat-collapseR.gif" : "cat-expandR.gif");
